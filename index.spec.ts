...
describe("kafkajs-avro 2", () => {
  ...
  it("can produce and consume multiple avro encoded messages (racing getSchema and encodeMessages)", async () => {
    const value = {
      customer: {
        name: "Test Testsson",
        address: `Test Avenue ${uuid()}`
...
describe("kafkajs-avro 3", () => {
  ...
  it("can produce and consume multiple (consecutive) avro encoded messages (racing getSchema and encodeMessages)", async () => {
    const value = {
      customer: {
        name: "Test Testsson",
        address: `Test Avenue ${uuid()}`
